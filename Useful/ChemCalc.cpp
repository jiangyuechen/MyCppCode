...
struct Part
{
    ...
    {
        if (deeper.empty())
            return getValue(remain) * double(mul);
...
{
    string s;
    cout << "Please insert the formula here. Insert \'0\' to exit.\nIf the formula has dots (such as NH3.H2O) , please ignore it (i.e. input NH3H2O).\nAttention! please insert the correct BRACKETS. The incorrect number of brackets such like (())) may cause the RUNTIME ERROR!\n";
    cin >> s;
    while (s != "0")
    {
